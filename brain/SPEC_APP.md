...
**Priority 1 SOP Audit Mobile Application**

**TECHNICAL SPECIFICATION**

**& CLAUDE CODE BUILD MANUAL**

तांत्रिक तपशील आणि क्लॉड कोड बांधणी पुस्तिका

*Companion to Saagar_P1_Audit_Workbook_v1*

*v1.0  •  Flutter + Firebase  •  May 2026*
...
| CRITICAL \| अत्यावश्यक<br>READ THIS PAGE FIRST. This document is the build manual. The Workbook (Saagar_P1_Audit_Workbook_v1) is the operational truth. Both go together. Reading either alone will produce a broken app.<br>हे पान आधी वाचा. हा दस्तऐवज बांधणी पुस्तिका आहे. पुस्तिका (Saagar_P1_Audit_Workbook_v1) कार्यवाहक सत्य आहे. दोन्ही एकत्र जातात. एकटा कोणताही वाचला तर तुटलेले अॅप होईल. |
| --- |


## How the two documents relate

*दोन दस्तऐवज एकमेकांशी कसे जोडलेले*

The Workbook is the operational ground truth. It defines what the audit programme IS — which SOPs exist, what each checkpoint means, how scoring works, when to escalate, what a CAP looks like. The Workbook does not change because we are building an app; the app must conform to the Workbook, never the other way around. If anything in this Spec contradicts the Workbook, the Workbook wins.

पुस्तिका कार्यवाहक सत्य आहे. ऑडिट कार्यक्रम काय आहे ते ती ठरवते — कोणते एसओपी आहेत, प्रत्येक तपासणी बिंदूचा अर्थ काय, स्कोअरिंग कसे होते, कधी एस्केलेट करायचे, CAP कशी दिसते. आपण अॅप बनवत आहोत म्हणून पुस्तिका बदलत नाही; अॅपने पुस्तिकेशी जुळवून घेतले पाहिजे, उलट नाही. या तपशीलात पुस्तिकेच्या विरुद्ध काही असेल — पुस्तिका जिंकते.

This Specification is the build manual. It translates the Workbook into screens, data fields, button behaviours, score formulas in code, and explicit instructions to Claude Code. It exists because Claude Code cannot read the Workbook and infer the app — it would invent half the answers and they would be wrong. This document gives Claude Code zero room to invent. Every Workbook rule that the app must enforce is restated here as a concrete app instruction with a cross-reference back to the Workbook section that originated it.

ही तपशील पुस्तिका बांधणी पुस्तिका आहे. पुस्तिकेला स्क्रीन, डेटा फील्ड, बटण वर्तन, कोडमधले स्कोअर सूत्र, आणि क्लॉड कोडसाठी स्पष्ट सूचना यांत अनुवादित करते. ती अस्तित्वात आहे कारण क्लॉड कोड पुस्तिका वाचून अॅप अंदाजे जाणू शकत नाही — अर्धी उत्तरे शोधेल आणि ती चुकीची असतील. हा दस्तऐवज क्लॉड कोडला शोधण्याची जागा देत नाही. अॅपने अंमलात आणायचा प्रत्येक पुस्तिका नियम इथे ठोस अॅप सूचना म्हणून पुन्हा सांगितला आहे — मूळ पुस्तिका विभागाच्या संदर्भासह.

## How to use these two files with Claude Code

*क्लॉड कोडसह हे दोन फाइल कसे वापरायचे*

- Upload BOTH files to Claude Code at the start of every session: Saagar_P1_Audit_Workbook_v1.docx AND this Specification document.
*प्रत्येक सत्राच्या सुरुवातीला क्लॉड कोडमध्ये दोन्ही फाइल अपलोड करा: Saagar_P1_Audit_Workbook_v1.docx आणि ही तपशील पुस्तिका.*

- Tell Claude Code: "Read the Specification first, then refer to the Workbook only when the Specification points you to a specific section."
*क्लॉड कोडला सांगा: "आधी तपशील वाचा, मग जेव्हा तपशील तुम्हाला विशिष्ट विभागाकडे निर्देश करते तेव्हाच पुस्तिकेचा संदर्भ घ्या."*

- Use the Master Prompt in Section 14 of this document. Paste it verbatim at the start of each Phase. Do not paraphrase it — the wording is calibrated to give Claude Code the right boundaries.
*या दस्तऐवजाच्या विभाग १४ मधील मास्टर प्रॉम्प्ट वापरा. प्रत्येक टप्प्याच्या सुरुवातीला तो जसाच्या तसा पेस्ट करा. वाक्ये बदलू नका — क्लॉड कोडला योग्य मर्यादा देण्यासाठी शब्द कॅलिब्रेट केलेले आहेत.*

- Build one Phase at a time. Do not start Phase 2 until Phase 1 is signed off using the Definition of Done in Section 16.
*एका वेळी एक टप्पा बांधा. विभाग १६ मधल्या Definition of Done वापरून टप्पा १ साइन-ऑफ होईपर्यंत टप्पा २ सुरू करू नका.*
...
**Section 13**  Test Scenarios — Per Phase
